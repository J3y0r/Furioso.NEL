...
namespace FuriosoNEL.Component
{
    ...
    {
        _ads.Clear();
        _ads.Add(new AdItem { Text = "最好的国际加速IP: FisProxy | 低价、稳定、低延迟", Url = "https://fisproxy.org/", ButtonText = "官方网站" });
        _ads.Add(new AdItem { Text = "Haedus Injection | 您的下一个热注入客户端 | 已运营3年", Url = "https://haed.us/", ButtonText = "官方网站" });
